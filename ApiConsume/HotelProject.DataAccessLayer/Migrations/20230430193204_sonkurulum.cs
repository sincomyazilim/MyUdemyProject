...
namespace HotelProject.DataAccessLayer.Migrations
{
    public partial class sonkurulum : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                name: "CategoryContactMessages",
                columns: table => new
                {
                    CategoryContactMessageId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    CategoryContactMessageName = table.Column<string>(type: "nvarchar(max)", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_CategoryContactMessages", x => x.CategoryContactMessageId);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Contacts_CategoryContactMessages_CategoryContactMessageId",
                        column: x => x.CategoryContactMessageId,
                        principalTable: "CategoryContactMessages",
                        principalColumn: "CategoryContactMessageId",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Contacts_CategoryContactMessageId",
                table: "Contacts",
                column: "CategoryContactMessageId");
        }
